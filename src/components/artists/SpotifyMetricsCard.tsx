...
import { RefreshCw, Music2, Users, TrendingUp, Play, ExternalLink } from 'lucide-react';
import { useArtistSpotifyMetrics, useFetchSpotifyMetrics, TopTrack } from '@/hooks/useSpotifyMetrics';
