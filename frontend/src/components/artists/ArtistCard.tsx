...
export function ArtistCard({
  ...
  // Agora mostramos para TODOS os artistas, pois as métricas podem ser carregadas mesmo sem URLs
  ...
  const totalStreams = topTracksFromMetrics.slice(0, 5).reduce((sum: number, track: any) => {
