-- =====================================================
-- SCRIPT COMPLETO DE CORREÇÃO DE SCHEMA - PARTE 1
...
ALTER TABLE releases ADD COLUMN IF NOT EXISTS artist_id UUID;
...
-- TABELA: projects
ALTER TABLE projects ADD COLUMN IF NOT EXISTS artist_id UUID;
...
ALTER TABLE music_registry ADD COLUMN IF NOT EXISTS artist_id UUID;
...
ALTER TABLE phonograms ADD COLUMN IF NOT EXISTS artist_id UUID;
...
ALTER TABLE marketing_campaigns ADD COLUMN IF NOT EXISTS artist_id UUID;
...
ALTER TABLE creative_ideas ADD COLUMN IF NOT EXISTS artist_id UUID;
...
SELECT 'Parte 1 executada com sucesso - colunas adicionadas!' as resultado;
